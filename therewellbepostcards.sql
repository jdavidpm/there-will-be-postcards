...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2019 a las 05:43:24
...
INSERT INTO `administrator` (`idmanager`, `email`, `password`) VALUES
(1, 'prueba@gmail.com', 'd8578edf8458ce06fbc5bb76a58c5ca4');
...
--
-- Estructura de tabla para la tabla `received_sent`
--

CREATE TABLE `received_sent` (
...
--
-- Volcado de datos para la tabla `received_sent`
--

INSERT INTO `received_sent` (`idreceiver`, `idsender`, `idpost`, `sign`, `datepost`) VALUES
(1, 0, 1, '', '2019-11-28'),
(0, 1, 1, '', '2019-11-28'),
(4, 4, 3, 'De mi para mi', '2019-11-28'),
(1, 1, 1, '', '2019-12-02'),
(0, 1, 1, '', '2019-12-02'),
(0, 1, 3, '', '2019-12-02'),
(2, 1, 9, 'Hi!', '2019-12-02'),
...
(2, 'Holden', 'Caulfield', 'prueba2@live.com', 'd8578edf8458ce06fbc5bb76a58c5ca4', 'Male', '2019-03-11'),
(3, '', '', '', 'd41d8cd98f00b204e9800998ecf8427e', '', '0000-00-00'),
(4, 'Jose Antonio', 'Ortiz', 'jaortizr@gmail.com', 'd8578edf8458ce06fbc5bb76a58c5ca4', 'Male', '2004-02-11');
...
--
ALTER TABLE `administrator`
  MODIFY `idmanager` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `postcard`
  MODIFY `idpostcard` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
