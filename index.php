...
<body class="greyish">
	...
	<div id="index-banner" class="parallax-container">
		<div class="section no-pad-bot">
			...
			<div class="hide-on-large-only">
					...
					<div class="row center">
						<a href="#" id="toGallery" class="btn-large waves-effect waves-dark bluec righteous">Every Postcard</a>
						<a href="#" id="toGallery" class="btn-large waves-effect waves-dark bluec righteous">Most Beloved</a>
					</div>
				</div>
		</div>
		<div class="parallax"><img src="background.jpg" alt="Unsplashed background img 1"></div>
	</div>
	...
	<div class="parallax-container valign-wrapper">
		...
		<div class="parallax"><img src="background2b.jpg" alt="Unsplashed background img 2"></div>
	</div>
