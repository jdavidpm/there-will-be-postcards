	...
	<main class="center-align">
		<div id ="panelProfile" class="row" style="margin: 5% 5% 5% 5%;">
			...
			<div id="recentlySent" class="col s2 m2 l2 card-panel">
				<form>
				<h4 class="staat"></h4>
				<div class="divider"></div><h4 class="staat"></h4>
				<button type="submit" class="btn bluec righteous waves-effect waves-ligh" formaction="showStatistics.php" id="showStats">Stats Postcards</button><h4 class="staat"></h4>
				<div class="divider"></div><h4 class="staat"></h4>
				<button type="submit" class="btn bluec righteous waves-effect waves-ligh" formaction="uploadPostcard.php" id="buttonNewPost" alt="New Postcard">New Postcard</button><h4 class="staat"></h4>
				<h4 class="staat"></h4>
				</form>
			</div>
		</div>
